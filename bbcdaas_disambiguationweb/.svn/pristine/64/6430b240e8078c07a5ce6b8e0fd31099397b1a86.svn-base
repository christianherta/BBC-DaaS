package de.bbcdaas.disambiguationweb.service.membership;

import de.bbcdaas.disambiguationweb.beans.membership.UserDetailsImpl;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	@Autowired private DisambiguationWebDao dao;
