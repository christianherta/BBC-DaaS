				...
				<div style="overflow: auto;height: 500px;">
					...
					<c:if test="${themeCloudTermCount ne 0}">
						...
						<div id="blockStyleThemeCloud">
							<div style="background-color: white;margin-bottom: 5px;padding: 1px;min-height: 100px;" class="dnd_target" id="dnd_target_white">
								...
								<c:forEach var="themeCloudTerm" items="${sessionScope[sessionContainer].themeCloudSessionBean.themeCloud}">
									<c:if test="${themeCloudTerm.rating eq 0}">
										...
										<span class="dnd_node" id="n${themeCloudTerm.id}" name="node_${themeCloudTerm.id}"
							...
							<div style="background-color: gray;margin-bottom: 5px;padding: 1px;min-height: 50px;" class="dnd_target" id="dnd_target_gray">
								<c:set var="i" value="1"/>
								<c:forEach var="themeCloudTerm" items="${sessionScope[sessionContainer].themeCloudSessionBean.themeCloud}">
									<c:if test="${themeCloudTerm.rating eq 1}">
										<c:if test="${i ne 1}">, </c:if>
										<span class="dnd_node" id="n${themeCloudTerm.id}">
							...
							<div style="background-color: red;padding: 1px;margin-bottom: 15px;min-height: 50px;" class="dnd_target" id="dnd_target_red">
								<c:set var="i" value="1"/>
								<c:forEach var="themeCloudTerm" items="${sessionScope[sessionContainer].themeCloudSessionBean.themeCloud}">
