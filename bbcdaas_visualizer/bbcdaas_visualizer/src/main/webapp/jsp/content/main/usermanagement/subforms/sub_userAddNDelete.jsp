...
<c:set var="handleUserManagementForm" value="<%=VisualizerConstants.FORWARD_HANDLE_USER_MANAGEMENT_FORM_CONTROL %>" />

<form method="post" id="userManagementForm" action="">

	<div>
		
		<input type="hidden" id="task" name="task"/> 
		<c:set var="confirmDeleteUserQuestion" value="<spring:" />
		...
		<div style="float:left;">
			...
			<table border="0">
				<tr>
					<td>
						<spring:message code="project.username" />:
					</td>
					<td>
